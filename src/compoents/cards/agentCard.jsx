...
const AgentCard = ({image = agent1, name, instagram, linkendIn, pinterest}) => {
    return (
        <div className="sm:w-full w-[90%] hover:border-primaryColor bg-white border rounded-md cursor-pointer drop-shadow-md flex flex-col items-center gap-3 py-10 hover:scale-105 duration-500">
