        ...
        <>
            ...
            <section className="flex justify-center items-center md:py-32 py-20">
                <div className="lg:w-[70%] md:w-[80%] sm:w-[75%] w-[80%] flex flex-col gap-14 justify-center items-center">
                    <div className="w-full grid md:grid-cols-[2fr_3fr] grid-cols-1 md:gap-20 gap-14 justify-items-center items-center mb-6">
                        <div className="relative md:h-auto max-h-72 justify-center items-center bg-red-300 md:row-start-auto row-start-2 mr-6">
                            <div className="h-full w-full absolute border-8 border-primaryColor top-6 left-6">
                                <div className="absolute w-[45%] h-[45%] bg-primaryColor right-0 bottom-0 text-white flex flex-col justify-center items-center text-center gap-2">
                        ...
                        <div className="flex flex-col lg:gap-5 md:gap-3 gap-4 md:row-start-auto row-start-1">
                            <h3 className="lg:text-3xl md:text-2xl text-lg font-semibold">Are You Looking Best Property Near You? Contact Us</h3>
