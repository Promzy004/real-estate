    ...
    return (
        <div>
            ...
            <div className="md:py-20 py-14 lg:w-[60%] md:w-[70%] sm:w-[75%] w-[90%] mx-auto">
                <form action="" method="post" className="flex flex-col justify-center items-center md:gap-10 gap-7 border rounded-sm shadow-md shadow-blue-50 md:py-14 sm:py-12 py-8">
                    <h3 className="relative pb-2 lg:text-4xl md:text-3xl text-2xl font-medium">Create Your Account</h3>
